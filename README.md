...
:green_circle: مدیریت چند سرور (Multi-Server) <br>
...
## مدیریت چند سرور (Multi-Server)
شما می توانید یک سرور را به عنوان **سرور مادر (Master)** انتخاب کنید و سایر سرورها را به عنوان **نود (Node)** به آن متصل کنید.
در این حالت، تمام کاربران روی سرور مادر ساخته می شوند و به صورت خودکار روی تمام سرورهای نود نیز ایجاد می شوند.
ترافیک مصرفی کاربران از تمام سرورها جمع آوری شده و در سرور مادر نمایش داده می شود.

### راه اندازی:
1. ایکس پنل را روی تمام سرورها نصب کنید.
2. وارد پنل سرورهای **نود** شوید، به بخش تنظیمات -> API بروید و یک توکن API جدید بسازید.
3. وارد پنل سرور **مادر** شوید.
4. از منوی سمت راست، گزینه **Multi-Server** را انتخاب کنید.
5. دکمه **Add New Node** را بزنید و اطلاعات سرور نود (IP, Port, API Token) را وارد کنید.
6. وضعیت را روی Active قرار دهید و ذخیره کنید.

اکنون هر تغییری در کاربران سرور مادر، روی نودها نیز اعمال می شود.
